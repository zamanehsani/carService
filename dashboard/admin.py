...
class InvoiceAdmin(admin.ModelAdmin):
    list_display = ['id', 'name', 'invoice_number', 'quantity','supplier_number', 'date', 'image', 'price', 'description', 'company', 'user']
    list_display_links = ['id', "name", 'quantity','invoice_number','supplier_number', 'date']
